...
const ja: LocaleStrings = {
  ...
  settingsLanguageSection: '言語 / ロケール',
  ...
  settingsLanguageLabel: 'UI言語',
  settingsLanguageHint: 'すべてのグラスのUIテキストとスマートフォンのラベルを変更します。SDKがCJKフォントをサポートするまで、CJK言語はラテン文字のフォールバックを使用します。',
