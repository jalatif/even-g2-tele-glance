const en = {
  ...
  settingsLanguageSection: 'Language / Locale',
  ...
  settingsLanguageLabel: 'UI Language',
  settingsLanguageHint: 'Changes all glasses UI text and phone labels. CJK languages use Latin-script fallback until the SDK supports CJK fonts.',
